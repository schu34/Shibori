# UI Workspace Overhaul

- [x] Replace the stacked page with a viewport-filling editor shell.
- [x] Add the accessible icon tool rail and compact application actions.
